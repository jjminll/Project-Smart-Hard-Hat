...
#define DEVICE_NAME         "SmartHardHat-003"
...
// const char* mqtt_server = "192.168.0.168"; // Node-RED 서버 IP  "smartadmin.aictlab.com" // 서버 홈페이지
...
void setup() {
  ...
  xTaskCreate(led, "EmergencyLED", 2048, NULL, 2, NULL);
...
##### 헬멧 하드웨어 최종본
![KakaoTalk_20250407_143144840_02](https://github.com/user-attachments/assets/3aaa9bcd-f1b3-4e7f-b13a-bc41350ecaa9)
![KakaoTalk_20250407_143144840](https://github.com/user-attachments/assets/ee2ce3da-8437-4c6a-84a8-1ae00dda85ce)
![KakaoTalk_20250407_143144840_01](https://github.com/user-attachments/assets/e18afe00-e605-42fa-a745-ec4211c52427)
![KakaoTalk_20250407_143144840_03](https://github.com/user-attachments/assets/b62132e5-6089-4fa9-bd8a-4cd0781cee4f)

##### 사업화 전략 검토
- 현 시장에 나와있는 스마트 안전모들과는 달리 가격대면에서 우세하기 떄문에 충분히 경쟁력이 있어보임.
- 많은 기능들이 있는 다른 안전모들과는 달리 가장 필요한 몇가지의 기능들만 있는 저희의 안전모는 기능적인 면에서는
  부족함이 있지만 낮은 가격대와 가장 필요한 기능들로 어필 가능할 것이라 판단됨.
- 초기에는 큰 공장이 아닌 작은 공장들을 위주로 협업 및 판매를 하여 아이템의 가능성을 판단하고자 함.
#### 최종 발표 자료 제작 및 시연 준비
- 기능 사용 영상 제작.
